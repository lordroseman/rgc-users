...
const userMenuPopover = useTemplateRef("user-menu");
    ...
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        ...
        <Popover ref="user-menu">
          ...
          <div
            class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-100"
          >
            Apps
          </div>
          <div class="grid grid-cols-3 gap-4 p-4">
            ...
            <a
              href="#"
              class="block p-4 text-center rounded-lg hover:bg-gray-100 group hover:text-red-500"
              @click="authStore.logout()"
            >
              <svg
                aria-hidden="true"
                class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-red-500"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="text-sm text-gray-900 group-hover:text-red-500">Logout</div>
            </a>
          </div>
        </Popover>
        <!-- Dropdown menu -->
